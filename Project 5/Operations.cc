...
bool Operations::createTable() { // CREATE TABLE
...
bool Operations::insertInto() { // INSERT INTO
  DBFile table;
...
bool Operations::dropTable() { // DROP TABLE
  // delete from catalog
...
bool Operations::exists(const char* relName) {
  ifstream fin (catalog_path);
  string line;
  while (getline(fin, line))
